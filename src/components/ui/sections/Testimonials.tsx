...
const Testimonials = () => {
  return (
    <div className="flex flex-col justify-center items-center py-12 px-4 lg:px-20 sm:px-6 -mt-20">
      <h2 className="text-2xl lg:text-lg sm:text-3xl font-bold mb-2 text-center">Testimonials</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gray-100 rounded-2xl p-4 sm:p-6 lg:p-10  shadow-sm hover:shadow-2xl transition duration-300">
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <p className="text-gray-500 mb-2 sm:mb-4 text-sm sm:text-base">Technical Adviser</p>
            <p className="text-gray-700 italic text-sm sm:text-base">
              "Payslab has been amazing — the UI/UX is smooth and super easy to use!"
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-100 rounded-2xl p-4 sm:p-6 lg:p-10 shadow-sm hover:shadow-2xl transition duration-300">
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <p className="text-gray-500 mb-2 sm:mb-4 text-sm sm:text-base">Freelancer</p>
            <p className="text-gray-700 italic text-sm sm:text-base">
              "Getting paid has never been easier — fast, secure and stress-free!"
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-100 rounded-2xl p-4 sm:p-6 lg:p-10 shadow-sm hover:shadow-2xl transition duration-300">
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <p className="text-gray-500 mb-2 sm:mb-4 text-sm sm:text-base">Designer</p>
            <p className="text-gray-700 italic text-sm sm:text-base">
