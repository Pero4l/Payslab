  ...
  return (
    <div className="flex flex-col items-center justify-center  mt-40 relative">
      <div className="text-center">
        <h1 className="font-bold uppercase text-9xl">A new way to</h1>
        {words.map((word, i) => (
          <motion.h1
            key={word}
            ...
            className="font-bold uppercase text-9xl text-blue-700"
          >
            {word}
          </motion.h1>
        ))}
      ...
      <div className="mt-40 flex flex-col">
        ...
        <div className="flex flex-col mt-10 lg:pl-18">
          <h2 className="text-3xl font-medium text-gray-900 mb-4">
            Borderless multi-currency accounts
          </h2>
          <p className="text-2xl max-w-2xl text-neutral-700 mb-4">
          ...
          <Link href="#" className="text-blue-700 text-2xl hover:underline">
        ...
        <div className="flex flex-col mt-10 lg:pl-18 mb-20">
          <h2 className="text-3xl font-medium text-gray-900 mb-4">
      ...
      <div className="flex flex-col bg-blue-600 w-full py-18">
        <video
          ...
          loop
          playsInline
          className="object-cover w-full h-[800] px-8"
        />
        <div className="flex flex-col mt-10 lg:pl-18">
          <h2 className="text-3xl font-medium text-gray-50 mb-4">
            Move money globally in seconds
          </h2>
          <p className="text-2xl max-w-2xl text-gray-300 mb-4">
          ...
          <Link href="#" className="text-gray-50 text-2xl hover:underline">
